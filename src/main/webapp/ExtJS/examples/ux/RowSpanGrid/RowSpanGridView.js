 ...
 */
/**
 * @class Ext.grid.RowSpanGridView
 ...
 */
Ext.grid.RowSpanGridView = Ext.extend(Ext.grid.GridView, {
...
[
    ...
    initTemplates: function() {
        Ext.grid.RowSpanGridView.superclass.initTemplates.apply(this, arguments);
    ...
    initElements: function() {
        Ext.grid.RowSpanGridView.superclass.initElements.apply(this, arguments);
    ...
    getGridInnerWidth: function() {
        var previousWidth = Ext.grid.RowSpanGridView.superclass.getGridInnerWidth.apply(this, arguments);
    ...
    onLayout: function(width, height) {
        Ext.grid.RowSpanGridView.superclass.onLayout.apply(this, arguments);
